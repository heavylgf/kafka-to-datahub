...
public class ConsumerRunnable implements Runnable {
    ...
    public ConsumerRunnable(List<FilePropertiesMapModel> filePropertiesMapModelList, String projectName,
    ...
    public void run() {
        ...
        while (true) {
            consumerMessageAutoCommit(filePropertiesMapModelList, projectName, datahubClient);
        }
